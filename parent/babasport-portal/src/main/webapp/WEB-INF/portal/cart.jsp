			...
			<div class="cart-inner">
				<div class="cart-thead clearfix">
					<div class="column t-checkbox form">
						<input checked="checked" type="checkbox" onclick="checkAll(checked)"></input> <label
						...
						<div id="product_11345721" class="item item_selected ">
							<div class="item_form clearfix">
								<div class="cell p-checkbox">
									<input checked="checked" class="checkbox" type="checkbox" name="skuIds"
										value="${item.skuId }">
								</div>
								<div class="cell p-goods">
									<div class="p-img">
										...
										<c:forTokens items="${item.sku.imgUrl}" delims="," begin="0" end="0" var="iu">
										
										<img
											src="${iu}"
											alt="${item.sku.productName}" width="52" height="52">
									...
									<div class="p-name">
										<a href="javascrip:;"> ${item.sku.productName}--
											${item.sku.colorname }-- ${item.sku.size} </a>
									</div>
								</div>
								...
								<c:if test="${item.isHave==true}">
									<div class="cell p-inventory stock-11345721">有货</div>
								</c:if>
								
								<c:if test="${item.isHave==false}">
									<div class="cell p-inventory stock-11345721">无货</div>
								</c:if>
				...
				<div class="cart-toolbar clearfix">
					<div class="total fr">
						<p>
							<span class="totalSkuPrice">¥${cart.productPrice }</span>商品金额：
						</p>
						<p>
							<span id="totalRePrice">- ¥${cart.fee }</span>运费：
						</p>
					</div>
					<div class="amout fr">
						<span id="selectedCount">${cart.productAmount }</span> 件商品
					</div>
				</div>
				<div class="ui-ceilinglamp-1" style="width: 988px; height: 49px;">
					<div class="cart-dibu ui-ceilinglamp-current"
						...
						<div class="cart-total-2014">
							...
							<div class="total fr">
								总计： <span class="totalSkuPrice">¥${cart.totalPrice }</span>
							</div>
						</div>
					</div>
				</div>
