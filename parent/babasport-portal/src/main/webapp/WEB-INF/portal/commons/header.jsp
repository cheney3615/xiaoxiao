...
function serachKeyword(sort,pageNum){
	...
	window.location.href =
		"/search?keyword=" + $("#keyword").val()+"&sort="+sort+"&pageNum="+pageNum+"&pageSize=7";
}
</script>
<!--shortcut start-->
		...
		<div id="search-2013">
			<div class="i-search ld">
				...
				<div class="form">
					...
					<input type="button" value="搜索" class="button" onclick="serachKeyword('${sort2}',1)" >
				</div>
			</div>
			<div id="hotwords"></div>
		</div>
		...
		<div id="settleup-2013">
			<dl>
				<dt class="ld">
					...
					<a href="/cart" id="settleup-url">去购物车结算</a>
				</dt>
<!-- 				<dd>
					<div class="prompt">
