...
<!-- <script type="text/javascript" src="http://localhost:8081/isLogin.aspx"></script> -->
...
function login()
{
	window.location = "http://localhost:8081/login.aspx?returnUrl="+encodeURIComponent(window.location);
}
	...
	<div class="w">
		...
		<ul class="fr lh">
			<li class="fore1" id="loginbar" clstag="homepage|keycount|home2013|01b">
				您好！<span id="username"></span>欢迎来到新巴巴运动网！
