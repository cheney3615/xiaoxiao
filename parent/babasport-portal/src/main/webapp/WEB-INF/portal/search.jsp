...
{
	//alert(brandId);
	window.location = '/search?keyword=${keyword}&sort=${sort2}&brandId='+brandId+"&pa=${pa}&pb=${pb}";
}
...
{
	window.location = 
		'/search?keyword=${keyword}&sort=${sort2}&brandId=${brandId}&pa='+pa+'&pb='+pb;
}
</script>
			...
			<div class="sl-b-selected J_brandSelected">
				<span class="crumbs-arrow">已选条件：</span>
					<c:forEach items="${map }" var="m">
						<a title="依琦莲（yiqilian）"  href="javascript:alert('haha');" class="crumb-select-item">
		...
		<div class="sl-value">
			<div class="sl-v-list">
				<ul class="J_valueList">
					...
					<li>
						<a href="javascript:;" onclick="fqPrice(1600,-1)"><i></i>1600以上</a>
					</li>
				</ul>
			</div>
		</div>
		...
		<div class="ml-wrap">
			<div id="J_filter" class="filter">
				<div class="f-line top">
					<div class="f-sort"><a href="javascript:;" class="curr">综合排序<i></i></a><a href="javascript:;" class="">销量<i></i></a><a href="javascript:serachKeyword('${sort}',1);" class="">价格<i></i></a><a href="javascript:;" class="" >评论数<i></i></a><a href="javascript:;" class="">新品<i></i></a></div>
					<div class="f-search">
					...
					<div id="J_topPage" class="f-pager"><span class="fp-text">
					<b>${pageSuperPojos.pageNum}</b><em>/</em><i>${pageSuperPojos.pages}
					</i></span><a class="fp-prev disabled" href="javascript:;">&lt;</a>
					
					<a class="fp-next" onclick="serachKeyword('${sort2}',${pageSuperPojos.pageNum+1})" 
...
<div id="J_goodsList" class="goods-list-v1 gl-type-1 J-goods-list">
	<ul class="gl-warp clearfix" data-tpl="1">
		...
		<li data-sku="1711416562" class="gl-item">
			<div class="gl-i-wrap">
				<div class="p-img">
					<a href="javascript:;" onclick="window.open('/product/detail?productId=${product.id}')" style="position: relative;">
						
						<%-- <a href="javascript:;" onclick="window.open('http://localhost:8083/html/product/${product.id}.html')" style="position: relative;"> --%>
						
						<img width="220" height="220" class="err-product"  src="${product.url}">
